...
class TL(commands.Cog):
    ...
    async def translator(self, inter, language, text):
        ...
        embed.add_field(name="`in this language do translate: `", value=f"**{language}**", inline=True)
        embed.add_field(name="`The word do translate is: `", value=f"**{translation.text}**", inline=False)
